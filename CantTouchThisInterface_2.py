...
def appEntered(appToBlock):
  return appToBlock

def websiteEntered(websiteToBlock):
  return websiteToBlock

def pinNumberEntered(pinNumber):
  return pinNumber

def blockLevelEntered(blockLevel):
  return blockLevel

def numMinutesEntered(numMinutes):
  return numMinutes

def numHoursEntered(numHours):
  return numHours
